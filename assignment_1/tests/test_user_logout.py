...
def test_logout_confirmation_yes(mocker, user_input, expected):
    ...
    mocker.patch("assignment_1.online_shopping_cart.user.user_logout.UserInterface.get_user_input", side_effect=[user_input])
...
def test_logout_with_non_empty_cart(mocker, capsys):
    ...
    mocker.patch("assignment_1.online_shopping_cart.user.user_logout.UserInterface.get_user_input", side_effect='n')
