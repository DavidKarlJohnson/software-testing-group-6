import pytest
from tasks_1_and_2.online_shopping_cart.product import product_data
...
def test_get_products_single_valid(mocker):
    ...
    mocker.patch('tasks_1_and_2.online_shopping_cart.product.product_data.get_csv_data', return_value=data)
...
def test_get_products_passes_filename(mocker):
    ...
    mocker.patch('tasks_1_and_2.online_shopping_cart.product.product_data.get_csv_data', side_effect=fake_get_csv)
