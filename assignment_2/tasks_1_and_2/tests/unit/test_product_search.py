import pytest
from tasks_1_and_2.online_shopping_cart.product.product_search import display_csv_as_table, display_filtered_table
...
def test_display_csv_as_table_default_file(mocker, capsys):
    ...
    mocker.patch('tasks_1_and_2.online_shopping_cart.product.product_search.get_csv_data', return_value=(mock_header, mock_data))
...
def test_display_csv_as_table_file_not_found(mocker):
    ...
    mocker.patch('tasks_1_and_2.online_shopping_cart.product.product_search.get_csv_data', side_effect=FileNotFoundError)
